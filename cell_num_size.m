...
% cell sizes vs. time for all genes on same graph
figure(6)
xlabel('time')
ylabel('average size of cell (pixel)')
hold on
scatter(1:94,wt_s,'ro')
scatter(1:94,cdk2_s,'bo')
scatter(1:93,cdk4_s,'go')
scatter(1:95,ccnd1_s,'r*')
scatter(1:94,ccne1_s,'b*')
legend('wildtype','CDK2 knockout','CDK4 knockout','CCND1 knockout','CCNE1 knockout')
end